...
const COLUMN_CONFIG = {
    easylist: new Set([
        ...
        'annoyances-cookies',
        'annoyances-overlays',
        'annoyances-social', 'annoyances-social-opt',
        'annoyances-widgets','annoyances-widgets-opt',
        'annoyances-others',
        'annoyances-notifications', 'annoyances-notifications-opt',
        'annoyances-ai',
    ]),
    adguard: new Set([
...
const VARIANT_PAIRS = [
    ...
    { full: 'annoyances-social',          opt: 'annoyances-social-opt' },
    { full: 'annoyances-widgets',         opt: 'annoyances-widgets-opt' },
    { full: 'annoyances-notifications',   opt: 'annoyances-notifications-opt' },
